...
public class FlavorsController : ControllerBase
{
    ...
    {
        var data = await _flavorService
            .GetAllAsync(paginationParams);

        return Ok(
            ApiResponse<PagedResponse<FlavorDto>>
                .Ok(data));
    }
      ...
      [FromForm] CreateFlavorDto dto)
    {
        ...
        return CreatedAtAction(
            ...
            ApiResponse<FlavorDto>.Ok(
                result.Data,
                "Sabor creado exitosamente"));
    }
     ...
     [FromForm] UpdateFlavorDto dto) 
    {
        ...
        return Ok(
            ApiResponse<object>
                .Ok(null!,
                    "Sabor actualizado exitosamente"));
    }
